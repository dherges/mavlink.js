...
mavlink.MODE_MANUAL_DIRECT = 1 // Raw input pulse widts sent to output
mavlink.MODE_MANUAL_SCALED = 2 // Inputs are normalized using calibration, the converted back to raw
                        // pulse widths for output
mavlink.MODE_AUTO_PID_ATT = 3 //  dfsdfs
mavlink.MODE_AUTO_PID_VEL = 4 //  dfsfds
mavlink.MODE_AUTO_PID_POS = 5 //  dfsdfsdfs
mavlink.UALBERTA_AUTOPILOT_MODE_ENUM_END = 6 // 

// UALBERTA_NAV_MODE
mavlink.NAV_AHRS_INIT = 1 // 
mavlink.NAV_AHRS = 2 // AHRS mode
mavlink.NAV_INS_GPS_INIT = 3 // INS/GPS initialization mode
mavlink.NAV_INS_GPS = 4 // INS/GPS mode
mavlink.UALBERTA_NAV_MODE_ENUM_END = 5 // 

// UALBERTA_PILOT_MODE
mavlink.PILOT_MANUAL = 1 //  sdf
mavlink.PILOT_AUTO = 2 //  dfs
mavlink.PILOT_ROTO = 3 //  Rotomotion mode
mavlink.UALBERTA_PILOT_MODE_ENUM_END = 4 // 
...
mavlink.MAVLINK_MSG_ID_NAV_FILTER_BIAS = 220
mavlink.MAVLINK_MSG_ID_RADIO_CALIBRATION = 221
mavlink.MAVLINK_MSG_ID_UALBERTA_SYS_STATUS = 222
...
*/
mavlink.messages.nav_filter_bias = function(usec, accel_0, accel_1, accel_2, gyro_0, gyro_1, gyro_2) {

    this.format = '<Qffffff';
    this.id = mavlink.MAVLINK_MSG_ID_NAV_FILTER_BIAS;
...
mavlink.messages.nav_filter_bias.prototype = new mavlink.message;

mavlink.messages.nav_filter_bias.prototype.pack = function(mav) {
    return mavlink.message.prototype.pack.call(this, mav, this.crc_extra, jspack.Pack(this.format, [ this.usec, this.accel_0, this.accel_1, this.accel_2, this.gyro_0, this.gyro_1, this.gyro_2]));
}
...
*/
mavlink.messages.radio_calibration = function(aileron, elevator, rudder, gyro, pitch, throttle) {

    this.format = '<3H3H3H2H5H5H';
    this.id = mavlink.MAVLINK_MSG_ID_RADIO_CALIBRATION;
...
mavlink.messages.radio_calibration.prototype = new mavlink.message;

mavlink.messages.radio_calibration.prototype.pack = function(mav) {
    return mavlink.message.prototype.pack.call(this, mav, this.crc_extra, jspack.Pack(this.format, [ this.aileron, this.elevator, this.rudder, this.gyro, this.pitch, this.throttle]));
}
...
*/
mavlink.messages.ualberta_sys_status = function(mode, nav_mode, pilot) {

    this.format = '<BBB';
    this.id = mavlink.MAVLINK_MSG_ID_UALBERTA_SYS_STATUS;
...
mavlink.messages.ualberta_sys_status.prototype = new mavlink.message;

mavlink.messages.ualberta_sys_status.prototype.pack = function(mav) {
    return mavlink.message.prototype.pack.call(this, mav, this.crc_extra, jspack.Pack(this.format, [ this.mode, this.nav_mode, this.pilot]));
}
...
mavlink.map = {
        220: { format: '<Qffffff', type: mavlink.messages.nav_filter_bias, order_map: [0, 1, 2, 3, 4, 5, 6], crc_extra: 34 },
        221: { format: '<3H3H3H2H5H5H', type: mavlink.messages.radio_calibration, order_map: [0, 1, 2, 3, 4, 5], crc_extra: 71 },
        222: { format: '<BBB', type: mavlink.messages.ualberta_sys_status, order_map: [0, 1, 2], crc_extra: 15 },
