...
mavlink.MAVLINK_MSG_ID_ARRAY_TEST_0 = 150
mavlink.MAVLINK_MSG_ID_ARRAY_TEST_1 = 151
mavlink.MAVLINK_MSG_ID_ARRAY_TEST_3 = 153
mavlink.MAVLINK_MSG_ID_ARRAY_TEST_4 = 154
mavlink.MAVLINK_MSG_ID_ARRAY_TEST_5 = 155
mavlink.MAVLINK_MSG_ID_ARRAY_TEST_6 = 156
mavlink.MAVLINK_MSG_ID_ARRAY_TEST_7 = 157
mavlink.MAVLINK_MSG_ID_ARRAY_TEST_8 = 158
...
*/
mavlink.messages.array_test_0 = function(v1, ar_i8, ar_u8, ar_u16, ar_u32) {

    this.format = '<4I4HB4s4s';
    this.id = mavlink.MAVLINK_MSG_ID_ARRAY_TEST_0;
...
mavlink.messages.array_test_0.prototype = new mavlink.message;

mavlink.messages.array_test_0.prototype.pack = function(mav) {
    return mavlink.message.prototype.pack.call(this, mav, this.crc_extra, jspack.Pack(this.format, [ this.ar_u32, this.ar_u16, this.v1, this.ar_i8, this.ar_u8]));
}
...
*/
mavlink.messages.array_test_1 = function(ar_u32) {

    this.format = '<4I';
    this.id = mavlink.MAVLINK_MSG_ID_ARRAY_TEST_1;
    this.order_map = [0];
    this.crc_extra = 72;
...
mavlink.messages.array_test_1.prototype = new mavlink.message;

mavlink.messages.array_test_1.prototype.pack = function(mav) {
    return mavlink.message.prototype.pack.call(this, mav, this.crc_extra, jspack.Pack(this.format, [ this.ar_u32]));
}
...
*/
mavlink.messages.array_test_3 = function(v, ar_u32) {

    this.format = '<4IB';
    this.id = mavlink.MAVLINK_MSG_ID_ARRAY_TEST_3;
    this.order_map = [1, 0];
    this.crc_extra = 19;
...
mavlink.messages.array_test_3.prototype = new mavlink.message;

mavlink.messages.array_test_3.prototype.pack = function(mav) {
    return mavlink.message.prototype.pack.call(this, mav, this.crc_extra, jspack.Pack(this.format, [ this.ar_u32, this.v]));
}
...
*/
mavlink.messages.array_test_4 = function(ar_u32, v) {

    this.format = '<4IB';
    this.id = mavlink.MAVLINK_MSG_ID_ARRAY_TEST_4;
    this.order_map = [0, 1];
    this.crc_extra = 89;
...
mavlink.messages.array_test_4.prototype = new mavlink.message;

mavlink.messages.array_test_4.prototype.pack = function(mav) {
    return mavlink.message.prototype.pack.call(this, mav, this.crc_extra, jspack.Pack(this.format, [ this.ar_u32, this.v]));
}
...
*/
mavlink.messages.array_test_5 = function(c1, c2) {

    this.format = '<5s5s';
    this.id = mavlink.MAVLINK_MSG_ID_ARRAY_TEST_5;
    this.order_map = [0, 1];
    this.crc_extra = 27;
...
mavlink.messages.array_test_5.prototype = new mavlink.message;

mavlink.messages.array_test_5.prototype.pack = function(mav) {
    return mavlink.message.prototype.pack.call(this, mav, this.crc_extra, jspack.Pack(this.format, [ this.c1, this.c2]));
}
...
*/
mavlink.messages.array_test_6 = function(v1, v2, v3, ar_u32, ar_i32, ar_u16, ar_i16, ar_u8, ar_i8, ar_c, ar_d, ar_f) {

    this.format = '<2dI2I2i2fH2H2hB2s2s32s';
    this.id = mavlink.MAVLINK_MSG_ID_ARRAY_TEST_6;
...
mavlink.messages.array_test_6.prototype = new mavlink.message;

mavlink.messages.array_test_6.prototype.pack = function(mav) {
    return mavlink.message.prototype.pack.call(this, mav, this.crc_extra, jspack.Pack(this.format, [ this.ar_d, this.v3, this.ar_u32, this.ar_i32, this.ar_f, this.v2, this.ar_u16, this.ar_i16, this.v1, this.ar_u8, this.ar_i8, this.ar_c]));
}
...
*/
mavlink.messages.array_test_7 = function(ar_d, ar_f, ar_u32, ar_i32, ar_u16, ar_i16, ar_u8, ar_i8, ar_c) {

    this.format = '<2d2f2I2i2H2h2s2s32s';
    this.id = mavlink.MAVLINK_MSG_ID_ARRAY_TEST_7;
...
mavlink.messages.array_test_7.prototype = new mavlink.message;

mavlink.messages.array_test_7.prototype.pack = function(mav) {
    return mavlink.message.prototype.pack.call(this, mav, this.crc_extra, jspack.Pack(this.format, [ this.ar_d, this.ar_f, this.ar_u32, this.ar_i32, this.ar_u16, this.ar_i16, this.ar_u8, this.ar_i8, this.ar_c]));
}
...
*/
mavlink.messages.array_test_8 = function(v3, ar_d, ar_u16) {

    this.format = '<2dI2H';
    this.id = mavlink.MAVLINK_MSG_ID_ARRAY_TEST_8;
...
mavlink.messages.array_test_8.prototype = new mavlink.message;

mavlink.messages.array_test_8.prototype.pack = function(mav) {
    return mavlink.message.prototype.pack.call(this, mav, this.crc_extra, jspack.Pack(this.format, [ this.ar_d, this.v3, this.ar_u16]));
}
...
mavlink.map = {
        150: { format: '<4I4HB4s4s', type: mavlink.messages.array_test_0, order_map: [2, 3, 4, 1, 0], crc_extra: 26 },
        151: { format: '<4I', type: mavlink.messages.array_test_1, order_map: [0], crc_extra: 72 },
        153: { format: '<4IB', type: mavlink.messages.array_test_3, order_map: [1, 0], crc_extra: 19 },
        154: { format: '<4IB', type: mavlink.messages.array_test_4, order_map: [0, 1], crc_extra: 89 },
        155: { format: '<5s5s', type: mavlink.messages.array_test_5, order_map: [0, 1], crc_extra: 27 },
        156: { format: '<2dI2I2i2fH2H2hB2s2s32s', type: mavlink.messages.array_test_6, order_map: [8, 5, 1, 2, 3, 6, 7, 9, 10, 11, 0, 4], crc_extra: 14 },
        157: { format: '<2d2f2I2i2H2h2s2s32s', type: mavlink.messages.array_test_7, order_map: [0, 1, 2, 3, 4, 5, 6, 7, 8], crc_extra: 187 },
        158: { format: '<2dI2H', type: mavlink.messages.array_test_8, order_map: [1, 0, 2], crc_extra: 106 },
